...
#    Then Write data into Json data file "<WriteTestData>"
    Examples:
      |RCTusername | RCTPassword  	|customer	|ThisCustomer					|	OriginLocationID	|	DestLocationID	|	pickUpDate	|	DeliveryDate	|	BillingType	|OrderType	|EquipmentType	|weight	|JDAusername| JDAPassword	|ItemCode  | ItemDescription      | ItemQuantity | PlanID| WaitTime |WriteTestData |Division|Logistic Group|
      |mitulpatel     | mitulpatel		|EMA		|Electrolux Major Appliances	|41-RDC-UWA				|0070080101 		|	1			|	0				|Prepaid		|Inbound	| Flatbed		|5000	|RYDADMIN	|RYDADMIN		|240336803 | SPACER-HINGE (BLACK) | 10 	         |1662 |20000     |EMA_Tendered |EMA1         | EMA5             |
      |mitulpatel     | mitulpatel		|EMA		|Electrolux Major Appliances	|41-RDC-UWA				|0070080101 		|	1			|	0				|Prepaid		|Inbound	| Flatbed		|5000	|RYDADMIN	|RYDADMIN		|240336803 | SPACER-HINGE (BLACK) | 10 	         | 1662|20000     |EMA_Canceled |EMA1         | EMA5             |
